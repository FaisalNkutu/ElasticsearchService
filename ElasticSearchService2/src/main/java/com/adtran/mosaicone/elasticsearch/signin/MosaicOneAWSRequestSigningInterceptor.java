package com.adtran.mosaicone.elasticsearch.signin;
 ...
 */
public class MosaicOneAWSRequestSigningInterceptor implements HttpRequestInterceptor {
    /**
     * The services that we're connecting to. Technically not necessary.
    ...
    /**
     *
     * @param services  that is used to connect to
     * @param signer particular signer implementation
     * @param awsCredentialsProvider source of AWS credentials for signing
     */
    public MosaicOneAWSRequestSigningInterceptor(final String service,
                                              final Signer signer,
